  ...
  <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('backend.banks.store') }}">
          @csrf
      ...
      <div class="modal-content">
        ...
        <form id="formUpdate" action="#">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Kode Bank <span class="text-danger">*</span></label>
              <input type="text" name="kode_bank" class="form-control" readonly/>
            </div>
            <div class="form-group">
              <label>Nama Bank <span class="text-danger">*</span></label>
              <input type="text" name="bank_name" class="form-control"/>
  ...
  <script>
    $(document).ready(function () {
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        let kode_bank = event.relatedTarget.getAttribute('data-bs-id');
        let bank_name = event.relatedTarget.getAttribute('data-bs-bank_name');
        this.querySelector('input[name=kode_bank]').value = kode_bank;
        this.querySelector('input[name=bank_name]').value = bank_name;
        this.querySelector('#formUpdate').setAttribute('action', '{{ route("backend.banks.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
      });
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.banks.index") }}/' + id);
      });
