...
@section('content')
  <div class="col-lg-12 col-md-6">
    <div class="card custom-card">
      <form id="formStore" action="{{ route('backend.videos.store') }}">
        @csrf
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-8">
              ...
              <div class="form-group">
                ...
                <input id="urlYoutube" type="text" class="form-control"/>
                <input type="hidden" class="form-control" name="body"/>
              </div>
              <iframe id="boxview" width="100%" height="315" src="https://www.youtube.com/embed/" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
