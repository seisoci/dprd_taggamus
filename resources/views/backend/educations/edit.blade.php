...
@section('content')
  <div class="col-lg-12 col-md-6">
    <div class="card custom-card">
      <form id="formUpdate"
            action="{{ route('backend.partai-member.educations.update', ['partai_member'=> $partaiMember['id'], $data['id']]) }}">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="name_institution" class="form-control"
                       value="{{ $data['name_institution'] ?? '' }}">
              </div>
              <div class="form-group">
                <label>Jurusan</label>
                <input type="text" name="major" class="form-control" value="{{ $data['major'] ?? '' }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" name="entry_year" class="form-control" value="{{ $data['entry_year'] ?? '' }}">
              </div>
              <div class="form-group">
